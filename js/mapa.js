...
info.update = function(props){
    this._div.innerHTML = '<h4>Total Viviendas </h4>' + 
                            ...
                            : 'Pase el puntero por cualquier poligonal');
};
...
L.marker([10.4968300, -66.5304963]).addTo(map)
    .bindPopup('Codigo <br> C-MIX-2021-05-0009.')
    .openPopup();
...
// Agregar atribucion
map.attributionControl.addAttribution('&copy; HCL Digital.upf Municipio Zamora - Miranda ');